...
class MinConflicts:
    def __init__(self, variables, dominios, restricciones, max_iter=100):
        """
        Inicializa el algoritmo de Mínimos-Conflictos.
    ...
    def resolver(self):
        """
        Resuelve el CSP utilizando el algoritmo de Mínimos-Conflictos.
        """
...
min_conflicts_solver = MinConflicts(variables, dominios, restricciones)
solucion = min_conflicts_solver.resolver()  # Aplicamos el algoritmo de Mínimos-Conflictos.
